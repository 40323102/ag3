...
ag3_40323102 = Blueprint('ag3_40323102', __name__, url_prefix='/ag3_40323102', template_folder='templates')
...
@ag3_40323102.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@ag3_40323102.route('/circle36/<x>/<degree>', defaults={'y': 0})
@ag3_40323102.route('/circle36/<x>/<y>/<degree>')
...
@ag3_40323102.route('/circle35/<x>/<y>/<degree>/<a>/<b>/<degree2>')
...
@ag3_40323102.route('/a')
def draw_a():
    return head_str + chain_str + a(0, 0) + tail_str
@ag3_40323102.route('/task50_1')
def task50_1():
    outstring = '''
<!DOCTYPE html>
<html>
...
@ag3_40323102.route('/threegear', defaults={'n1':15,'n2':20,'n3':18})
@ag3_40323102.route('/threegear/<n1>/<n2>/<n3>')
